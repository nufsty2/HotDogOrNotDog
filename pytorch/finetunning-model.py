...
def finetune_and_save(path):
    ...
    trans=transforms.Compose([transforms.Resize(400),transforms.CenterCrop(size=[224,224]),transforms.ToTensor(),])
    #create data loader
    data = ImageFolder(root='pytorch/train_set', transform=trans)
...
finetune_and_save("pytorch/hotdog-model")
